...
public class BTWRApiLangGenerator extends FabricLanguageProvider {

    public BTWRApiLangGenerator(FabricDataOutput dataOutput, CompletableFuture<RegistryWrapper.WrapperLookup> registryLookup) {
