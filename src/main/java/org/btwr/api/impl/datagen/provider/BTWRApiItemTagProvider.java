...
public class BTWRApiItemTagProvider extends FabricTagProvider.ItemTagProvider {

    public BTWRApiItemTagProvider(FabricDataOutput output, CompletableFuture<RegistryWrapper.WrapperLookup> completableFuture) {
