...
public class BTWRConventionalTags {
    ...
    public static class Blocks {
        ...
        // Registering BTWR Conventional tags under the "b" namespace
        private static TagKey<Block> createTag(String tagId) {
            return TagKey.of(RegistryKeys.BLOCK, Identifier.of("b", tagId));
        }
    }
    ...
    public static class Items {
        ...
        private static TagKey<Item> createTag(String tagId) {
            return TagKey.of(RegistryKeys.ITEM, Identifier.of("b", tagId));
        }
    }
