...
import org.btwr.api.impl.mixin.accessor.ShapelessRecipeJsonBuilderAccessor;
...
public class ExtendedShapelessRecipe extends ShapelessRecipe implements AdditionalDropsRecipe, CraftingWithToolRecipe {
    ...
    public RecipeType<?> getType() {
        return BTWRApiRecipes.EXTENDED_SHAPELESS_RECIPE_TYPE;
    }

    @Override
    public RecipeSerializer<?> getSerializer() {
        return BTWRApiRecipes.EXTENDED_SHAPELESS_RECIPE_SERIALIZER;
    }
